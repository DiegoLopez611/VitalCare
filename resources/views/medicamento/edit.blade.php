        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <h3 class="text-lg font-medium text-gray-900 mb-6">Editar Medicamento</h3>
                    ...
                    <form method="POST" action="{{ route('medicamentos.update', $medicamento->id) }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-input id="nombre" class="block mt-1 w-full bg-gray-100" type="text" name="nombre" value="{{ $medicamento->nombre }}" />
                                @error('nombre')
                            ...
                            <!-- Concentración -->
                            <div>
                                <x-label for="concentracion" value="Concentración" />
                                <x-input id="concentracion" class="block mt-1 w-full bg-gray-100" type="text" name="concentracion" value="{{ $medicamento->concentracion }}" />
                                @error('concentracion')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <!-- Nombre Laboratorio -->
                            <div>
                                <x-label for="nombre_laboratorio" value="nombre_laboratorio" />
                                <x-input id="nombre_laboratorio" class="block mt-1 w-full bg-gray-100" type="text" name="nombre_laboratorio" value="{{ $medicamento->nombre_laboratorio }}" 5 />
