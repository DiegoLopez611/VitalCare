                    ...
                    <form method="POST" action="{{ route('medicos.update', $medico->id) }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-input id="fecha_nacimiento" class="block mt-1 w-full bg-gray-100" type="date" name="fecha_nacimiento_disabled" value="{{ $medico->fecha_nacimiento }}" disabled />
                                <!-- Campo oculto para enviar el valor -->
                                <input type="hidden" name="fecha_nacimiento" value="{{ $medico->fecha_nacimiento }}">
                            </div>

                            <!-- Primer Nombre -->
                            <div>
                                <x-label for="primer_nombre" value="Primer Nombre" />
                                <x-input id="primer_nombre" class="block mt-1 w-full" type="text" name="primer_nombre" value="{{ $medico->primer_nombre }}" required />
                                @error('primer_nombre')
                            ...
                            <div>
                                ...
                                <x-input id="segundo_nombre" class="block mt-1 w-full" type="text" name="segundo_nombre" value="{{ $medico->segundo_nombre }}" />
                            ...
                            <div>
                                ...
                                <x-input id="primer_apellido" class="block mt-1 w-full" type="text" name="primer_apellido" value="{{ $medico->primer_apellido }}" required />
                            ...
                            <div>
                                ...
                                <x-input id="segundo_apellido" class="block mt-1 w-full" type="text" name="segundo_apellido" value="{{ $medico->segundo_apellido }}" />
                            ...
                            <div>
                                ...
                                <x-input id="email" class="block mt-1 w-full" type="email" name="email" value="{{ $medico->email }}" required />
                                @error('email')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <!-- Licencia Medica -->
                            <div>
                                <x-label for="licencia_medica" value="Email" />
                                <x-input id="licencia_medica" class="block mt-1 w-full" type="text" name="licencia_medica" value="{{ $medico->licencia_medica }}" required />
                                @error('email')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="mt-6">
                            ...
                            <textarea id="direccion" name="direccion" rows="3" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm block w-full">{{ $medico->direccion }}</textarea>
                            @error('direccion')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
